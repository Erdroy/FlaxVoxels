public static class ErdroysCube
{
	...
	public static readonly short[][] ErdroyUVTable = 
	{
		new short[] { -1 },
		new short[] { 2, 3, 0, 0, 1, 2, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, -1 },
		new short[] { 2, 1, 0, 0, 3, 2, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, -1 },
		new short[] { 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, -1 },
		...
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, -1 },
		new short[] { 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 1, 0, 0, 3, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		...
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0, -1 },
		new short[] { 2, 3, 0, 0, 1, 2, 2, 3, 0, 0, 1, 2, 2, 1, 0, 0, 3, 2, 1, 0, 3, 3, 2, 1, 1, 0, 3, 3, 2, 1, 0, 3, 2, 2, 1, 0 },
	};
}